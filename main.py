...
# ---------- FUNÇÃO DE GERAÇÃO DO PLANO DE AULA ----------
def gerar_plano(texto_tema: str) -> str:
    ...
    Títulos devem estar exatamente assim:
    **Objetivo Geral**
    **Objetivos Específicos**
    **Conteúdo Programático**
    **Exemplos Práticos**
...
async def gerar_pdf(pergunta: Pergunta):
    try:
        ...
        elementos = []
        elementos.append(Paragraph("<b>Plano de Aula — UNISUL</b>", estilo_titulo))
...
async def gerar_ppt(pergunta: Pergunta):
    try:
        ...
        slide.shapes.add_picture("static/unisul.png", Inches(7.5), Inches(0.3), height=Inches(1))
